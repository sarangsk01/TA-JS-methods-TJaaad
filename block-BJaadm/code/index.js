...
console.log(peopleName.filter((person) => person.sex == "F").filter((person) => person.name.startsWith("C") || person.name.startsWith("J"))  );
...
console.log(persons.find(person => person.name.startsWith == "J") && persons.grade > 10 && person.sex === "F");
